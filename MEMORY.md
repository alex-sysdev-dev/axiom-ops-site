## 2026-06-18, Logo preview asset
**What was decided:** Create an AxiomOps geometry logo preview as a static SVG in `public` and reference it from the existing header and hero.
**Why:** Alexander wanted to see how the uploaded technical A-mark would look on the site without changing the product copy, route structure, or broader page content.
**What was rejected:** Replacing the site with a full redesign or changing unrelated brand content. The preview stays limited to logo placement.

## 2026-06-27, Government R&D / SBIR capabilities positioning
